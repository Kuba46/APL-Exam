...
# На вход поступает строка. На C# отсортировать строку в новую строку с соседними элементами. Если длина исходной строки нечётная, то добавить в последнюю пару "_"
